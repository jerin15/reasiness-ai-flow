  ...
  ({ className, ...props }, ref) => {
    return (
      <Input
        ...
        data-sidebar="input"
        className={cn(
          "h-8 w-full bg-white/10 border-white/20 text-sidebar-foreground placeholder:text-sidebar-foreground/50 shadow-none focus-visible:ring-2 focus-visible:ring-sidebar-ring",
          className,
        )}
        {...props}
      />
