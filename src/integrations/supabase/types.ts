  ...
  public: {
    Tables: {
      ...
      game_rooms: {
        ...
        Relationships: [
          {
            foreignKeyName: "game_rooms_player1_id_fkey"
            columns: ["player1_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "game_rooms_player2_id_fkey"
            columns: ["player2_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      operations_whiteboard: {
        ...
        Relationships: [
          {
            foreignKeyName: "operations_whiteboard_assigned_to_fkey"
            columns: ["assigned_to"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "operations_whiteboard_completed_by_fkey"
          ...
          {
            foreignKeyName: "operations_whiteboard_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
